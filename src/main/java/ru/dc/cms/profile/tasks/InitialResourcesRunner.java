/*
 * Copyright (C) 2007-2024 Digitalchief Software Corporation. All Rights Reserved.
 *
...
package ru.dc.cms.profile.tasks;
...
public class InitialResourcesRunner implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.mongo = new MongoClient(mongo.getAddress(), List.of(credential));
